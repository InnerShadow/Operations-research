Layeb04 <- function(x) {
  ...
  #   f = (log(0.001) - 1)*(n - 1)
  #   x(i) = чередование 0 и (2i - 1)pi, где i - целое число
  #
  ...
  #   не выпуклая, без плато, нулевое решение, симметричная
  # -------------------------------------------------------------------------
